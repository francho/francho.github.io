...
- una [linterna pequeña de 400LM](https://www.amazon.es/dp/B096MHBSDG), con varios modos que alumbra un montón, muy útil cuando saco en invierno a los perros por caminos oscuros o para marcar mi posicion cuando ando de noche por carreteras. Además tiene un potente iman para fijarla o coger cosas metálicas.
- útiles de costura: hilo, aguja e imperdible
- un par de bridas pequeñas
- cinta americana
- silbato emergencias (impreso con la 3D)
- un [encendedor de ferrocerio](https://www.victorinox.com/es/Productos/Swiss-Army-Knife%E2%84%A2-and-Tools/Cuidado-de-navajas/Pedernal-para-Venture-Pro/p/4.1333), ahora que no fumo me ha sacado de más de un apuro en alguna barbacoa, aunque creo que este va a ir al EDC de la mochila de montaña y aqui meteré cerillas o un mechero pequeño que quepa
